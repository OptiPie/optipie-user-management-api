...
type CreateUserRequest struct {
	...
	LiveMode string `protobuf:"bytes,2,opt,name=live_mode,json=liveMode,proto3" json:"live_mode,omitempty"`
}
...
func (x *CreateUserRequest) GetLiveMode() string {
	if x != nil {
		return x.LiveMode
	}
	return ""
...
type CreateUserRequest_Data struct {
	...
	SupporterEmail string `protobuf:"bytes,4,opt,name=supporter_email,json=supporterEmail,proto3" json:"supporter_email,omitempty"`
}
...
func (x *CreateUserRequest_Data) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *CreateUserRequest_Data) GetAmount() int32 {
	if x != nil {
		return x.Amount
	}
	return 0
...
func (x *CreateUserRequest_Data) GetObject() string {
	if x != nil {
		return x.Object
	}
	return ""
...
func (x *CreateUserRequest_Data) GetSupporterEmail() string {
	if x != nil {
...
var file_user_management_api_proto_rawDesc = []byte{
	...
	0x74, 0x2d, 0x61, 0x70, 0x69, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xb5, 0x01, 0x0a, 0x11,
	...
	0x04, 0x74, 0x79, 0x70, 0x65, 0x12, 0x1b, 0x0a, 0x09, 0x6c, 0x69, 0x76, 0x65, 0x5f, 0x6d, 0x6f,
	0x64, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x6c, 0x69, 0x76, 0x65, 0x4d, 0x6f,
	0x64, 0x65, 0x1a, 0x6f, 0x0a, 0x04, 0x44, 0x61, 0x74, 0x61, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64,
	...
	0x28, 0x09, 0x52, 0x06, 0x6f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x12, 0x27, 0x0a, 0x0f, 0x73, 0x75,
	0x70, 0x70, 0x6f, 0x72, 0x74, 0x65, 0x72, 0x5f, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x18, 0x04, 0x20,
	...
	0x6d, 0x2f, 0x4f, 0x70, 0x74, 0x69, 0x50, 0x69, 0x65, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x6d, 0x61,
	0x6e, 0x61, 0x67, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x61, 0x70, 0x69, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_user_management_api_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_user_management_api_proto_goTypes = []interface{}{
	(*CreateUserRequest)(nil),      // 0: CreateUserRequest
	(*CreateUserRequest_Data)(nil), // 1: CreateUserRequest.Data
}
